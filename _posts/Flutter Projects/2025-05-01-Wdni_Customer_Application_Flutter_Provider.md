...
classes: wide
header:
  teaser: https://raw.githubusercontent.com/AbdoOo20/Images/refs/heads/main/Wdni/wdniCustomer.jpg
ribbon: MidnightBlue
categories:
  - Flutter_Projects
toc: true
...
- **Firebase (Auth, Database, Messaging, Storage)** — Real-time backend & notifications.
- **Google Maps & OSM** — Live tracking and location features.
- **Provider / GetX** — State management and dependency injection.
- **Shared Preferences / Get Storage** — Local data storage.
